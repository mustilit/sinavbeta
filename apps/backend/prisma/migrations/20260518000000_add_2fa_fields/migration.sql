...
-- Not: CONCURRENTLY Prisma migration transaction'ı içinde kullanılamaz; prod'da manuel INDEX oluşturulabilir.
CREATE INDEX IF NOT EXISTS "users_two_factor_enabled_idx"
