  ...
  async execute(prisma: {
    ...
    if (!row) {
      return {
        ...
        schoolAdminDeviceCheckEnabled: false,
        minPackagePriceCents: 100,
        minTunnelPriceCents: 0,
        minWrittenPriceCents: 0,
        ...
        maxWrittenTestsPerPackage: 10,
        minQuestionsPerWrittenTest: 1,
        maxQuestionsPerWrittenTest: 50,
        maxLiveQuestions: 50,
    ...
    return {
      ...
      maxWrittenTestsPerPackage: (row as any).maxWrittenTestsPerPackage ?? 10,
      minQuestionsPerWrittenTest: (row as any).minQuestionsPerWrittenTest ?? 1,
      maxQuestionsPerWrittenTest: (row as any).maxQuestionsPerWrittenTest ?? 50,
