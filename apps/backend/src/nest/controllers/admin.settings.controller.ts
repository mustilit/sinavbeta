  ...
  async update(@Body() dto: UpdateAdminSettingsDto, @Req() req: any) {
    ...
    return this.updateSettings.execute(
      this.prisma,
      {
        ...
        maxWrittenTestsPerPackage: dto.maxWrittenTestsPerPackage,
        minQuestionsPerWrittenTest: dto.minQuestionsPerWrittenTest,
        maxQuestionsPerWrittenTest: dto.maxQuestionsPerWrittenTest,
